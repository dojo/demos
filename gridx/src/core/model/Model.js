define(['dojo', './AsyncCache', './SyncCache'], function(dojo, AsyncCache, SyncCache){

return dojo.declare('demos.gridx.src.core.model.Model', null, {
	constructor: function(args){
		...
		this._connects = [
			...
			dojo.connect(this._model, "onSizeChange", this, "onSizeChange")
		];
	},
	destroy: function(){
	...
	_sort: function(sortSpec){
		...
		c.options.sort = dojo.clone(sortSpec);
		if(toSort){
			c.clear();
		}
