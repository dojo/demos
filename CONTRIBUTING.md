...
```bash
$ git clone --recursive git@github.com:username/demos.git
```

This will clone your fork to your current path in a directory named `demos`.
...
```bash
$ cd demos
$ git remote add upstream git@github.com:dojo/demos.git
$ git fetch upstream
```
