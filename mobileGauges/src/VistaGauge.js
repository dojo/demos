dojo.provide("demos.mobileGauges.src.VistaGauge");

dojo.require("dojox.gfx");
dojo.require("dojox.gfx.matrix");
dojo.require("dojox.gauges.AnalogGauge");

dojo.declare("demos.mobileGauges.src.VistaNeedle", [dojox.gauges.AnalogIndicatorBase], {
    // summary:
...
dojo.declare("demos.mobileGauges.src.VistaGauge", [dojox.gauges.AnalogGauge], {
	...
	drawForeground: function(group){
		...
		group1.createPath({
			...
			y2: -117.1321,
			colors: [
			         {offset: 0, color: [27,27,27,0.52941]},
			         {offset: 1, color: [27,27,27,0]}
			         ]
		});
